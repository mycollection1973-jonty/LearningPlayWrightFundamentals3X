...
test("Verify the error message in the wingify free trial", async({ page}) => {
    ...
    await page.locator("#free-trial-step1-gdpr-consent-checkboxcu-marketing-consent-checkbox").click();  // #id
    await page.locator("[data-qa=free-trial-step1-gdpr-consent-checkboxgdpr-consent-checkbox]").click(); //name
